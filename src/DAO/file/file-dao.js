const {dynamoDBClient} = require('../db-configs/dynamo-db')
const {S3TableParams} = require('../../handlers/generate-resources/create-dynamo-s3-path')
const {S3params} = require('../../handlers/generate-resources/create-s3-bucket')
const { v4: uuidv4 } = require('uuid');
const { awsS3 } = require('../aws-config/aws-s3');
